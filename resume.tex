...
\section{PROJECTS}
    ...
    \resumeSubHeadingListStart
       \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{\normalsize{For a given flight and weather data in the years 2016 and 2017, a two-stage machine learning model was built to predict flight delay.}}
            \resumeItem{\normalsize{In the process, different classification and regression models are studied and experimented to find the best classifier and regressor and the same was to observe the perfomance of the two-stage model.}}
          \resumeItemListEnd 
          \vspace{-13pt}
